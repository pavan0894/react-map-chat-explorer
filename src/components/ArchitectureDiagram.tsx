...
const DiagramNode: React.FC<{
  ...
  className?: string;
  delay?: number;
}> = ({ title, icon, logoSrc, description, className, delay = 0 }) => {
  return (
    <div 
    ...
    >
      <div className="flex items-center justify-center mb-2">
        ...
        {logoSrc && <img src={logoSrc} alt={`${title} logo`} className="w-8 h-8 object-contain" />}
      </div>
        ...
        <div className="flex flex-col items-center">
          <div className="flex flex-col md:flex-row items-center gap-6 mb-6">
            ...
            <DiagramNode 
              ...
              logoSrc="/lovable-uploads/84307225-af2c-4344-b04b-a1c45f7bfd83.png"
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 mb-6">
            <DiagramNode 
              ...
              logoSrc="/lovable-uploads/8911d264-0527-456a-94ba-213030c79ef5.png"
            ...
            <DiagramNode 
              ...
              logoSrc="/lovable-uploads/534ab8ec-d780-4a8b-adf8-06d1533cfb75.png"
          ...
          <DiagramNode 
            ...
            logoSrc="/lovable-uploads/035b24fa-e110-44f7-9f8a-38047074b89c.png"
